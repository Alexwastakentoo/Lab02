...
void matrixProduct(float *result, const float *matrix1, int row_dim1, const float *matrix2, int clm_dim2, int clm1_or_row2_dim); //computes the product of m1 and m2 stores in result
